  ...
  return (
    <div className="min-h-screen bg-[#e9edf2] pt-24 pb-20">
      <div className="max-w-[1920px] mx-auto px-10">
        ...
        {/* Header */}
        <div className="mb-16">
          <p className="text-[10px] font-bold uppercase tracking-[.3em] text-[#949dae] mb-4">
            Authorized Personnel
          </p>
          <h1 className="text-[42px] font-normal tracking-tight uppercase text-black leading-none">
            Account / profile
          </h1>
        </div>
        ...
        {/* Stats bar */}
        {stats && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-[1px] bg-black/5 mb-16 border-t border-b border-black/5">
            {[
              ...
              { label: 'Wishlist', value: stats.wishlist_count },
            ].map(({ label, value }) => (
              <div key={label} className="bg-white/40 backdrop-blur-sm p-8 text-center">
                <p className="text-[32px] font-normal text-black mb-1">{value}</p>
                <p className="text-[10px] uppercase font-bold tracking-[.2em] text-[#949dae]">
                  {label}
                </p>
              </div>
            ))}
        ...
        <div className="flex gap-12 border-b border-black/5 mb-16">
          {TABS.map(({ key, label, icon: Icon }) => (
            <button
              ...
              className={`flex items-center gap-3 pb-6 text-[11px] font-bold uppercase tracking-[.2em] transition-all relative
                ${activeTab === key ? 'text-black' : 'text-[#949dae] hover:text-black'}`}
            >
        ...
        <div className="max-w-4xl">
          {activeTab === 'profile' && (
            <div className="animate-fade-in">
              {profileSuccess && (
                <div className="mb-12 p-6 bg-black text-white text-[11px] uppercase tracking-[.2em] font-bold flex items-center gap-4">
                  <Check size={16} /> Data synchronized successfully
                </div>
              )}
